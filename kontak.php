<?php
// kontak.php - Halaman Kontak Lab Data Technology
$activePage = 'kontak';
include 'conn.php'; // Koneksi database
include 'navbar.php'; // Navbar

// Ambil data kontak yang aktif
$stmt_kontak = $pdo->query("SELECT * FROM kontak WHERE status = 'active' LIMIT 1");
$kontak = $stmt_kontak->fetch();

// Default values jika tidak ada data
$whatsapp = $kontak['whatsapp'] ?? '+62 812-3456-789';
$email = $kontak['email'] ?? 'datatechnologies.labti@gmail.com';
$alamat = $kontak['alamat'] ?? 'Gedung Sipil Lantai 8, Jurusan Teknologi Informasi, Politeknik Negeri Malang, Jl. Soekarno Hatta No.9, Malang, Jawa Timur 65141';
$telepon_kampus = '+62 341 404424';
$telepon_lab = $kontak['kontak'] ?? '+62 812-3456-789';
$jam_operasional = $kontak['jam_operasional'] ?? 'Senin - Jumat: 08.00 - 16.00 WIB';
$linkedin = $kontak['linkedin'] ?? '#';
$instagram = $kontak['instagram'] ?? '#';
$youtube = $kontak['youtube'] ?? '#';
$facebook = $kontak['facebook'] ?? '#';
$maps_embed = $kontak['maps'] ?? '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.4204766693547!2d112.61315207501!3d-7.946635392072286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e78827687d272e7%3A0x789ce9a636cd3aa2!2sPoliteknik%20Negeri%20Malang!5e0!3m2!1sid!2sid!4v1699999999999!5m2!1sid!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>';

// Format WhatsApp link - Hapus semua karakter non-angka dari nomor WhatsApp database
...
} elseif (substr($whatsapp_clean, 0, 2) !== '62') {
...
<section class="section kontak-cards-section">
  <div class="container">
    ...
    <div class="contact-cards-grid">
      ...
      <!-- WHATSAPP CARD -->
      <a href="<?= htmlspecialchars($whatsapp_link) ?>" target="_blank" class="contact-card whatsapp-card">
        <div class="card-icon">
        ...
        <h3>WhatsApp</h3>
        <p class="contact-value"><?= htmlspecialchars($whatsapp) ?></p>
      ...
      <!-- EMAIL CARD -->
      <a href="mailto:<?= htmlspecialchars($email) ?>?subject=Pertanyaan tentang Lab Data Technology" class="contact-card email-card">
        <div class="card-icon">
  ...
  <div class="container">
    ...
    <div class="info-grid">
      ...
      <div class="info-box">
        ...
        <h3>Telepon</h3>
        <p>
          <strong>Kampus:</strong> <?= htmlspecialchars($telepon_kampus) ?><br>
          <strong>Laboratorium:</strong> <?= htmlspecialchars($telepon_lab) ?><br>
          <br>
      ...
      <div class="info-box">
        ...
        <p><?= nl2br(htmlspecialchars($jam_operasional)) ?></p>
      ...
      <div class="info-box">
        ...
        <div class="social-links-alt">
          ...
          <a href="<?= htmlspecialchars($instagram) ?>" target="_blank" class="social-alt-link">
          ...
          <a href="<?= htmlspecialchars($youtube) ?>" target="_blank" class="social-alt-link">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="<?= htmlspecialchars($facebook) ?>" target="_blank" class="social-alt-link">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="<?= htmlspecialchars($linkedin) ?>" target="_blank" class="social-alt-link">
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
